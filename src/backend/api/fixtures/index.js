...
module.exports = (app, db, select) => {
  // show routes at top
  const setupApi = () => {
    app.get("/api/tournaments/:tournamentId/fixtures", fixturesByPitch);
    app.get("/api/tournaments/:tournamentId/fixtures/nextup", nextFixtures);
    app.get("/api/tournaments/:tournamentId/fixtures/:pitch", fixturesByPitch);
    app.get("/api/tournaments/:tournamentId/fixtures/:id/start", startFixture);
    app.post("/api/tournaments/:tournamentId/fixtures/:id/carded", cardPlayers);
    app.post("/api/tournaments/:tournamentId/fixtures/:id/score", updateScore);
  };
